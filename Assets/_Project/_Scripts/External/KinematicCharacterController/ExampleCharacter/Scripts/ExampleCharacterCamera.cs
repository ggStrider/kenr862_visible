...
namespace KinematicCharacterController.Examples
{
    public class ExampleCharacterCamera : MonoBehaviour
    {
        ...
        [Space] [SerializeField] private bool _enableScroll = false;
        [SerializeField, Range(1f, 100f)] private float _sensitivity = 30;
        ...
        {
            rotationInput /= 100;
            rotationInput *= _sensitivity;
            
            if (!_enableScroll) zoomInput = 0;
            if (FollowTransform)
            {
                if (InvertX)
                {
